    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Hi, deo!</h2>
                    ...
                    <div class="col-12 col-md-12 col-lg-5">
                        <div class="card profile-widget">
                            ...
                            <div class="profile-widget-description">
                                <div class="profile-widget-name">deo <div
                                        class="text-muted d-inline font-weight-normal">
                                        <div class="slash"></div> proflayer gaming
                                    </div>
                                </div>
                                deo is a proflayer gaming name in <b>Indonesia</b>,
                                He is someone who is generous and kind, also saves diligently and many say is also handsome
                                <b>'and this guy is so very very cool'</b>.
                            </div>
                            <div class="card-footer text-center">
                                <div class="font-weight-bold mb-2">Follow dheo On your sosmed</div>
                                <a href="#"
